...
SET SCRIPT="C:\OneDrive\CIPP\GEOPP - GEOPP\01-ENGENHARIA OPERACIONAL\13- ACOMP MENSAL OPERAÇÃO\Relatório Power Bi\RepositórioGIT\ImagemSequencia\ImagemSequencia.py" 
